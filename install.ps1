...
function Install-Scoop {
    ...
    if (Test-CommandAvailable('git')) {
        ...
        try {
            ...
            git clone --depth 5 -q $SCOOP_PACKAGE_GIT_REPO $SCOOP_APP_DIR
            if (-not $?) {
            ...
            git clone --depth 5 -q $SCOOP_MAIN_BUCKET_GIT_REPO $SCOOP_MAIN_BUCKET_DIR
            if (-not $?) {
                throw 'Cloning failed. Falling back to downloading zip files.'
            }
...
$SCOOP_PACKAGE_REPO = 'https://v6.gh-proxy.org/https://github.com/Adrts/Scoop-Adrts-Modified-Version/archive/main.zip'
$SCOOP_MAIN_BUCKET_REPO = 'https://v6.gh-proxy.org/https://github.com/ScoopInstaller/Main/archive/master.zip'

$SCOOP_PACKAGE_GIT_REPO = 'https://v6.gh-proxy.org/https://github.com/Adrts/Scoop-Adrts-Modified-Version.git'
$SCOOP_MAIN_BUCKET_GIT_REPO = 'https://v6.gh-proxy.org/https://github.com/ScoopInstaller/Main.git'
